...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Api.Domain.Entities.ActionDefinition", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("CompanyId", "ActionType")
                        .IsUnique();

                    b.ToTable("ActionDefinitions", (string)null);
                });

            modelBuilder.Entity("Api.Domain.Entities.ActionLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("ParametersEncrypted")
                        .IsRequired()
                        .HasColumnType("text");
                    ...
                    b.Property<string>("WebhookResponseJson")
                        .HasColumnType("text");
                    ...
                    b.HasIndex("CompanyId", "ExecutedAt");
            ...
            modelBuilder.Entity("Api.Domain.Entities.OtpVerification", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("PendingParametersJson")
                        .IsRequired()
                        .HasColumnType("text");
                    ...
                    b.HasIndex("ConversationId", "VerifiedAt", "ExpiresAt");
            ...
            modelBuilder.Entity("Api.Domain.Entities.ActionLog", b =>
                {
                    ...
                    b.HasOne("Api.Domain.Entities.ActionDefinition", "ActionDefinition")
                        .WithMany()
                        .HasForeignKey("ActionDefinitionId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("Api.Domain.Entities.Conversation", null)
                        .WithMany()
                        .HasForeignKey("ConversationId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

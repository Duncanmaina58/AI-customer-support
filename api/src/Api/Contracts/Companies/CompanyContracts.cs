...
/// <summary>
/// Partial update covering the Settings page AND onboarding wizard steps 1-3 + 5
/// (details, brand voice, business hours, escalation rules) — they're all just
/// Company fields, so one flexible endpoint serves both call sites instead of
/// near-duplicate ones. Null fields are left unchanged.
/// </summary>

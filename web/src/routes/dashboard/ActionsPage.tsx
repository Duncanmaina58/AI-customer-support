...
export function ActionsPage() {
  ...
  return (
    <div>
      <header className="animate-reveal mb-6 flex flex-wrap items-start justify-between gap-3">
        <div>
          <div className="mb-2 flex items-center gap-2">
            <Zap className="h-3.5 w-3.5 text-teal-400" />
            <span className="text-[11px] font-semibold uppercase tracking-[0.12em] text-teal-400">AI-triggered webhooks</span>
          </div>
        ...
        <div className="flex shrink-0 gap-2">
          <button
            ...
            className="flex items-center gap-2 rounded-lg border border-ink-700 px-3.5 py-2 text-sm font-medium text-line-200 transition-colors hover:bg-ink-800"
          >

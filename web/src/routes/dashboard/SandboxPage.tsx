    ...
    <div className="mx-auto max-w-3xl space-y-6 p-6">
      <div className="animate-reveal">
        <div className="mb-2 flex items-center gap-2">
          ...
          <span className="text-[11px] font-semibold uppercase tracking-[0.12em] text-teal-400">Safe testing ground</span>
        </div>
      ...
      {sandbox && (
        <div className="animate-reveal space-y-2 rounded-xl border border-ink-700 bg-ink-900 p-5">
          ...
          {canRegenerate && (
            <div className="flex items-center gap-3 pt-1">
              <button
                ...
                className="flex items-center gap-1.5 text-xs text-muted-400 transition-colors hover:text-line-200 disabled:opacity-60"
              >
      ...
      <div className="animate-reveal overflow-hidden rounded-xl border border-ink-700">
        <ChatPanel

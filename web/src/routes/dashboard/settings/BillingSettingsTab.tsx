          ...
          <div className="mt-3">
            ...
            <div className="flex items-center gap-2">
              ...
              <input
                ...
                className="w-full max-w-xs rounded-md border border-ink-700 bg-ink-950 px-2.5 py-1.5 text-sm text-line-200 placeholder:text-muted-400 focus:border-teal-400 focus:outline-none transition-colors"
              />
            </div>
          </div>
